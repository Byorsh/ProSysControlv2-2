  ...
  <div class="page-title">
    <div>
      ...
      <!--<ul class="breadcrumb side">
          ...
          <div><a class="btn btn-primary btn-flat" href="?c=domicilio&a=FormCrear">Añadir Servicio <i class="fa fa-lg fa-plus"></i></a></div>
        </div>
    ...
    <div class="form-group">
                    ...
                    <?php if(isset($_GET['q'])){
                         ...
                         <a class="btn btn-warning btn-flat" href="?c=domicilio<?= $url_paginacion ?>"  id="borrarBusButton"><i class="fa fa-lg fa-eraser"></i> Borrar busqueda</a>
                         <a class="btn btn-danger btn-flat" href="?c=domicilio&a=MostrarYaEntregados"  id="borrarBusButton"><i class="fa fa-lg fa-filter"></i> Terminados y cobrados</a>
                        ...
                        <button class="btn btn-primary" type="submit" id="submitButton"><i class="fa fa-lg fa-search"></i> Buscar</button>
                        <a class="btn btn-warning btn-flat" href="?c=domicilio"  id="borrarBusButton"><i class="fa fa-lg fa-eraser"></i> Borrar busqueda</a>
                        <a class="btn btn-danger btn-flat" href="?c=domicilio&a=MostrarYaEntregados"  id="borrarBusButton"><i class="fa fa-lg fa-filter"></i> Terminados y cobrados</a>
                        <?php
                      }
                      ?>
