...
function handleSubmit() {
    ...
    let password2 = patrones.password.test(document.getElementById('contraseña2').value);
    ...
    {document.getElementById('submitButton').disabled = false;document.getElementById('advertenciaContraseña2').hidden = true}
    else{handleBloquearSubmit();document.getElementById('advertenciaContraseña2').hidden = false;}
