            ...
            <form class="form-horizontal" method="POST" action="?c=domicilio&a=Guardar">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" id="obs" name="problematica" rows="4" placeholder="Problematica para el servicio" onkeyup="mayus(this)" onchange="handleSubmit()"></textarea>
