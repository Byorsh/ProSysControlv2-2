            ...
            <form class="form-horizontal" method="POST" onsubmit="handleSubmit()" action="?c=catalogo&a=Guardar">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="cantidad" id="cantidad" type="text" placeholder="Agrega la cantidad" value="<?= $catalogoSQL->getCantidad() ?>" onchange="handleSubmit()" maxlength="6" min="1" onkeypress="return ((event.charCode == 46) || (event.charCode == 44) || (event.charCode >= 48 && event.charCode <= 57))" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="alert alert-danger" role="alert" id="advertenciaPorcentajeCompra" hidden>
                      Debe ser cantidad en enteros
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="precioVenta" id="precioventatxt" type="text" placeholder="Agrega el precio de venta" value="<?= $catalogoSQL->getPrecioVenta() ?>" onchange="handleSubmit()" maxlength="12" min="1" onkeypress="return ((event.charCode == 46) || (event.charCode == 44) || (event.charCode >= 48 && event.charCode <= 57))" />
