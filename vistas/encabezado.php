...
<head>
  ...
  <script src="https://kit.fontawesome.com/4bbac97e5c.js" crossorigin="anonymous"></script>
    ...
    <aside class="main-sidebar hidden-print">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview"><a href="#"><i class="fa fa-users"></i><span>Clientes</span><i class="fa fa-angle-right"></i></a>
