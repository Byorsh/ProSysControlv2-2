              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="ns" id="ns" type="text" placeholder="Introduce el numero de serie del equipo" 
                      onkeyup="mayus(this)" onchange="handleSubmit()" maxlength="30" min="1" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 97 && event.charCode <= 122))" value="<?= $tallerSQL->getNs() ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" id="marca" name="marca" type="text" placeholder="Marca del equipo" 
                      onkeyup="mayus(this)"onchange="handleSubmit()" maxlength="50" min="1" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 45) || (event.charCode == 47) || (event.charCode == 32))" value="<?= $tallerSQL->getMarca() ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" id="modelo" name="modelo" type="text" placeholder="Modelo del equipo" 
                      onkeyup="mayus(this)" onchange="handleSubmit()" maxlength="50" min="1" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))" value="<?= $tallerSQL->getModelo() ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <textarea class="form-control" id="obs" name="observaciones" type="text" rows="4" placeholder="Problema del equipo" onkeyup="mayus(this)" onchange="handleSubmit()"><?= $tallerSQL->getObservaciones() ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" name="accesorios" id="accesorios" rows="4" placeholder="Accesorios del equipo" onkeyup="mayus(this)" onchange="handleSubmit()"><?= $tallerSQL->getAccesorios() ?></textarea>
                  </div>
                </div>
