<div class="content-wrapper">
  <div class="page-title">
    ...
    <div>
      <a class="btn btn-primary btn-flat" href="?c=catalogo&a=FormCrear">Añadir Articulo <i class="fa fa-lg fa-plus"></i></a>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        ...
        ?><input class="form-control" name="campo" id="campo" type="text" required value="<?= $_GET['q'] ?>">
          ...
          <a class="btn btn-warning btn-flat" href="?c=catalogo<?= $url_paginacion ?>" id="borrarBusButton"><i class="fa fa-lg fa-eraser"></i> Borrar busqueda</a>
        <?php //echo $url_busqueda;
        } else {
        ?>
          <input class="form-control" name="campo" id="campo" type="text" required>
          <button class="btn btn-primary" type="submit" id="submitButton"><i class="fa fa-lg fa-search"></i> Buscar</button>
          <a class="btn btn-warning btn-flat" href="?c=catalogo" id="borrarBusButton"><i class="fa fa-lg fa-eraser"></i> Borrar busqueda</a>
        <?php
        }
        ?>
